...
namespace API_Hospitalar.Migrations
{
    ...
    [Migration("20230414013338_AddFKAtendimen")]
    partial class AddFKAtendimen
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("API_Hospitalar.Models.MedicoModel", b =>
                {
                    ...
                    b.Property<int?>("AtendimentosId_Atendimento")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("AtendimentosId_Atendimento");
            ...
            modelBuilder.Entity("API_Hospitalar.Models.MedicoModel", b =>
                {
                    b.HasOne("API_Hospitalar.Models.Atendimentos", null)
                        .WithMany("Medico")
                        .HasForeignKey("AtendimentosId_Atendimento");
                });
